...
class ProductScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body:producState.isLoading 
      ? const FullScreenLoader()
      : _ProductView(product: producState.product!),
      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField( 
            ...
            onChanged: ref.read(productFromProvider(product).notifier).onTitleChanged,
            errorMessage: productForm.title.errorMessage,
          ),
          CustomProductField( 
            label: 'Slug',
            initialValue: productForm.slug.value,
            onChanged: ref.read(productFromProvider(product).notifier).onSlugChanged,
